...
class TRexEnv(gym.Env):
    ...
    def __init__(self, render_mode=None, num_obstacles=10):
        ...
        self.obstacle_heights = [40, 80, 120]  # Three possible heights
        ...
        # Action space: 0=no jump, 1=small jump, 2=medium jump, 3=high jump
    ...
    def generate_obstacles(self):
        ...
        x = self.width + 200  # Give player time to react
    ...
    def step(self, action):
        ...
        for obstacle in self.obstacles:
            ...
            if not obstacle["passed"] and obstacle["x"] + self.obstacle_width < self.player_x:
                ...
                obstacle_reward = 5 + (obstacle["height_idx"] * 5)  # 5 for low, 10 for medium, 15 for high
    ...
    def _render_frame(self):
        ...
        if self.render_mode == "human":
            ...
            controls_text = controls_font.render("A: Small Jump | S: Medium Jump | D: High Jump", True, (0, 0, 0))
